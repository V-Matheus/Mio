...
export { catalogAdminContract } from "./catalog/catalog-admin.contract"
export { gamificationContract } from "./gamification/gamification.contract"
export type { GrpcContract } from "./grpc-contract"
export { healthContract } from "./health/health.contract"
export { progressContract } from "./progress/progress.contract"
